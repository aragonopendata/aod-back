...
class DatasetController {
    ...
    getDetesetsAutocomplete(req, res) {
        try {
    ...
    getDatasetsByOrganization = (req, res) => {
        try {
    ...
    getDatasetHomerByPackageid = (req, res) => {
        try {
    ...
    getDatasetsByStatsSearch = (req, res) => {
        try {
    ...
    getDatasetResourceView = (req, res) => {
        try {
